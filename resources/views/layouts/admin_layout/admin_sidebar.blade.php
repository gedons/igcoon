  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="../pages/dashboard.html">
        <img src="{{ asset('images/admin_images/logo-ct.png') }}" class="navbar-brand-img h-100" alt="...">
        <span class="ms-1 font-weight-bold"><img style="width: 65px;" src="{{url('images/2.png')}}"></span>
      </a>
    </div>
    <hr class="horizontal dark mt-0">
    <div class="navbar-nav-main  w-auto">
      <ul class="navbar-nav">
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/tables.html">
            ...
            <span class="nav-link-text ms-1">Sponsored Posts</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="../pages/billing.html">
            ...
            <span class="nav-link-text ms-1">Verification Entries</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/sign-in.html">
            ...
            <span class="nav-link-text ms-1">Update Details</span>
          </a>
        </li>
        <li class="nav-item">
